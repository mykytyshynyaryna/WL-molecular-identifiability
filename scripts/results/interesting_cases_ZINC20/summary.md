...
- `sample_<pattern>.csv` (×4) and `grid_<pattern>.png` (where the subset is non-empty)
- `sample_reason_<category>.csv` and `grid_reason_<category>.png` per non-empty category
